<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="MakaleDuzenle.aspx.cs" Inherits="PixelForgeWebApp.AdminPanel.MakaleDuzenle" %>
    ...
    <div class="formTasiyici">
        ...
        <div class="formIcerik">
            <asp:Panel ID="pnl_basarili" runat="server" CssClass="basariliPanel" Visible="false">
                Makale başarı ile düzenlenmiştir
            </asp:Panel>
            ...
            <div class="sagIcerik">
                ...
                <div class="row">
                    <asp:LinkButton ID="lbtn_duzenle" runat="server" CssClass="buton" OnClick="lbtn_duzenle_Click">Makale Düzenle</asp:LinkButton>
